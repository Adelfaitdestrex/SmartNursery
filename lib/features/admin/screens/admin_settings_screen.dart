      ...
      body: SafeArea(
        ...
        child: Column(
          children: [
            ...
            OutlinedButton.icon(
              onPressed: () {},
              icon: const Icon(Icons.logout, color: AppColors.activityCardRed, size: 18),
              label: const Text(
                'Déconnexion',
                style: TextStyle(
                  fontFamily: 'Inter',
              ...
              style: OutlinedButton.styleFrom(
                ...
                side: const BorderSide(color: AppColors.activityCardRed, width: 2),
...
class _UserProfileSectionState extends State<_UserProfileSection> {
  ...
  void initState() {
    super.initState();
    _nomController = TextEditingController(text: 'Lefebvre');
    _prenomController = TextEditingController(text: 'Marie');
    _emailController = TextEditingController(text: 'm.lefebvre@ecole-everbloom.fr');
  }
                    ...
                    builder: (context, nomValue, child) {
                      return ValueListenableBuilder<TextEditingValue>(
                        ...
                        builder: (context, prenomValue, child) {
                          return Text(
                            '${prenomValue.text} ${nomValue.text}',
                            style: TextStyle(
          ...
          child: Column(
            children: [
              ...
              _InfoRow(
                ...
                value: '••••••••••••',
                isDefaultIcon: false,
                onTap: () {}, // The user can also change from the bottom Security section
                isLast: true,
              ),
            ],
          ),
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            Icon(
              valueText == null ? Icons.arrow_forward : Icons.keyboard_arrow_down,
              color: Colors.grey,
              size: 20,
            ),
          ],
