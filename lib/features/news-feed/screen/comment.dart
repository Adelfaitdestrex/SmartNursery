  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        leading: IconButton(
          icon: const Icon(Icons.arrow_back, color: Color(0xFF005224)), // 🔙 flèche retour
          onPressed: () {
...
class CommentCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final roleBg = isTeacher ? const Color(0xFF9DF898) : const Color(0xFF005EAE);
    final roleColor =
    isTeacher ? const Color(0xFF1A7425) : const Color(0xFFC2D9FF);
          ...
          children: [
            ...
            Row(
              children: [
                ...
                TextButton.icon(
                  onPressed: onReply,
                  icon: const Icon(Icons.reply, size: 16, color: Colors.black54),
