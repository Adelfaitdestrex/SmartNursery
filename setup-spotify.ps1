# SmartNursery YouTube Music Setup Script (PowerShell)
# This script helps you set up YouTube Data API integration

Write-Host "=========================================" -ForegroundColor Cyan
Write-Host "🎥 SmartNursery YouTube Music Setup" -ForegroundColor Cyan
Write-Host "=========================================" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "✅ functions\.env.local created (remember: DON'T commit this file!)" -ForegroundColor Green
Write-Host ""
...
Write-Host "1. Test locally: firebase emulators:start --only functions" -ForegroundColor White
Write-Host "2. Deploy to Firebase: firebase deploy --only functions" -ForegroundColor White
Write-Host "3. See YOUTUBE_SETUP.md for detailed instructions" -ForegroundColor White
Write-Host ""
